...
const AddRoom = () => {
  ...
  const {axios, geToken} = useAppContext()
    ...
    const onSubmitHandler = async (e) =>{
      ...
      try {
        ...
        const amenities = Object.keys(inputes.amenities).filter(key => inputes.amenities[key])
        formData.append('amenities', JSON.stringify(amenities))

        //Adding Images to FormData
        Object.keys(images).formEach((key)=>{
  ...
  return (
    <form onSubmit={onSubmitHandler}>
      <Title align='left' font='outfit' title='Add Room' subTitle='Fill in the details carefully and accurate details, pricing, and amenities, to enhance the user booking experience. '/>
